...
__decorate([
    common_1.Post(),
    swagger_1.ApiCreatedResponse({ type: article_entity_1.ArticleEntity }),
...
__decorate([
    common_1.Get(),
    swagger_1.ApiOkResponse({ type: article_entity_1.ArticleEntity, isArray: true }),
    __metadata("design:type", Function),
...
__decorate([
    common_1.Get(':id'),
    swagger_1.ApiOkResponse({ type: article_entity_1.ArticleEntity }),
